class SearchSubscription
  ...
  def send_subscription_email
    ...
    if (self.email_cadence == "daily" && self.last_sent_at.nil? || self.last_sent_at > Time.now-60*60*24) || (self.email_cadence == "weekly" && self.last_sent_at.nil? || self.last_sent_at > Time.now-60*60*24)
